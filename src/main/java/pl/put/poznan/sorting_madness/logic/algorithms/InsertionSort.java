...
public class InsertionSort implements Sortable {
    ...
    public static <T extends Comparable<T>> SortedDataResponse<T> insertionSort(List<T> array, SortingOrder order) {
    ...
    public static <T extends Comparable<T>> SortedDataResponse<T> limitedInsertionSort(List<T> array, int maxIterations, SortingOrder order) {
        // Loop through the array
